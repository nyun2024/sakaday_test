...
const initialState = {
  quizList: [
    ...
    {
      Q: '사카모토와 나구모가 JCC시절에 받은 발렌타인 초콜릿 개수를 더한 값은? (7점)',
      correctAnswer: '244',
      score: 7,
      type: 'input',
      hint: '2권 10화 마지막 보너스컷',
    },
    {
    ...
    {
      Q: '가쿠가 사용한 기술 중 하나로 중국 무술에서의 발경의 일종이며 예비동작없이 가까운 거리에서 공격을 가할 수 있는 이 기술의 이름은? (5점)',
      correctAnswer: '촌경',
      score: 5,
      type: 'input',
      hint: '17권 151화',
    ...
    {
      Q: '하루마가 전투 중에 접목시킨 스포츠를 [[모두]] 고르시오. (6점)',
